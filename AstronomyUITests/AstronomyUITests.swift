...
//  AstronomyUITests
//
//  Created by Lambda_School_Loaner_201 on 2/6/20.
...
class AstronomyUITests: XCTestCase {
    ...
    private func cell(forIndex index: Int) -> XCUIElement {
        return app.collectionViews.children(matching: .cell).matching(identifier:
            "PhotosCollectionViewController.ImageCell").element(boundBy: index).children(matching: .other).element
    }
